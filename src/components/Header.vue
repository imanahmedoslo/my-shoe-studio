<template>
  <Disclosure as="nav" class="bg-white shadow border-b-2" v-slot="{ open }">
    <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8 ">
      <div class="flex h-16 justify-between">
        <div class="flex px-2 lg:px-0">
          <div class="flex flex-shrink-0 items-center">
            <router-link to="/" class="cursor-pointer">
              <img class="h-8 w-auto cursor-pointer" :src="MyStyleLogo" alt="Your Company" />
            </router-link>
          </div>
          <!-- menu options ------------------------ -->
          <div class="hidden lg:ml-6 lg:flex lg:space-x-8">
            <!-- TODO: Use v-for and het the header from the store -->
            <router-link to="/BO/Dashboard" class="inline-flex items-center border-b-2 border-indigo-500 px-1 pt-1 text-sm font-medium text-gray-900 cursor-pointer">
              Dashboard
            </router-link>
        ...
        <div class="hidden lg:ml-4 lg:flex lg:items-center">
          <button @click="isCartOpen => !isCartOpen " type="button" class="relative flex-shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
...
import MyStyleLogo from '@/assets/icons/myStyleLogo.png'
